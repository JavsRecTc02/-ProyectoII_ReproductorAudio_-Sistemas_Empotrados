...
# Memory: Shared_RAM
MEM_1 := soc_system_Shared_RAM
$(MEM_1)_NAME := Shared_RAM
...
$(MEM_1)_START := 0x00030000
$(MEM_1)_END := 0x0003ffff
$(MEM_1)_SPAN := 0x00010000
$(MEM_1)_HIERARCHICAL_PATH := Shared_RAM
$(MEM_1)_WIDTH := 32
...
.PHONY: Shared_RAM
Shared_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
