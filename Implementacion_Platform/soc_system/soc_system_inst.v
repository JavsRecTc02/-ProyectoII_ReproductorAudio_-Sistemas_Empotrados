	soc_system u0 (
		.audio_if_0_conduit_end_export_xck        (<connected-to-audio_if_0_conduit_end_export_xck>),        //           audio_if_0_conduit_end.export_xck
		.audio_if_0_conduit_end_export_adcdat     (<connected-to-audio_if_0_conduit_end_export_adcdat>),     //                                 .export_adcdat
		.audio_if_0_conduit_end_export_adclrc     (<connected-to-audio_if_0_conduit_end_export_adclrc>),     //                                 .export_adclrc
		.audio_if_0_conduit_end_export_dacdat     (<connected-to-audio_if_0_conduit_end_export_dacdat>),     //                                 .export_dacdat
		.audio_if_0_conduit_end_export_daclrc     (<connected-to-audio_if_0_conduit_end_export_daclrc>),     //                                 .export_daclrc
		.audio_if_0_conduit_end_export_bclk       (<connected-to-audio_if_0_conduit_end_export_bclk>),       //                                 .export_bclk
		...
		.oc_i2c_master_0_conduit_start_export_scl (<connected-to-oc_i2c_master_0_conduit_start_export_scl>), //    oc_i2c_master_0_conduit_start.export_scl
		.oc_i2c_master_0_conduit_start_export_sda (<connected-to-oc_i2c_master_0_conduit_start_export_sda>), //                                 .export_sda
		.reset_reset_n                            (<connected-to-reset_reset_n>),                            //                            reset.reset_n
		.hex_low_pio_external_connection_export   (<connected-to-hex_low_pio_external_connection_export>),   //  hex_low_pio_external_connection.export
		.hex_high_pio_external_connection_export  (<connected-to-hex_high_pio_external_connection_export>)   // hex_high_pio_external_connection.export
	);
